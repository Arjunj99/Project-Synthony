...
public class DrawShape : MonoBehaviour
{
    ...
    void Start()
    {
        //Vector2[] vertices = new Vector2[] { new Vector2(2.5f, 2.5f), new Vector2(2.5f, -2.5f), new Vector2(0f, -2.5f) };
        ////Vector2[] vertices = new Vector2[] { new Vector2(0f, 2.5f), new Vector2(-1f, -2.5f), new Vector2(2.5f, -2.5f), new Vector2(2.5f, 2.5f) };
    ...
    public void DrawPolygon2D(Vector2[] vertices, ushort[] triangles, Color color, string name)
    {
        GameObject polygon = new GameObject(); //create a new game object
        polygon.name = name;
        //polygon.transform. = new Vector3(0, 0, 0);
        SpriteRenderer sr = polygon.AddComponent<SpriteRenderer>(); // add a sprite renderer
        BoxCollider2D bc2D = polygon.AddComponent<BoxCollider2D>(); // add a box collider
